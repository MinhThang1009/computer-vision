...
def construct_list_of_attributes(
    feature_dc_shape, feature_rest_shape, scaling_shape, rotation_shape
):
    l = ["x", "y", "z", "nx", "ny", "nz"]
...
for index, viewpoint in enumerate(scene.getTestCameras()):
    points, scales_final, rotations_final, opacity_final, shs_final = get_state_at_time(
        gaussians, viewpoint
    )
    ...
    gs_ply = init_3DGaussians_ply(
        ...
        opacity_final,
        shs_final,
        [feature_dc_shape, feature_rest_shape],
    )
