...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{HyperNeRF}~\cite{park2021hypernerf} (vrig): 4 cảnh \textit{thật} thu bằng 1--2 camera chuyển động đơn giản, $960\times540$ (bài báo cũng đánh giá).
...
và tổng hợp \textbf{đối sánh chéo ba dataset}: chất lượng 4D-GS giảm dần theo chiều
